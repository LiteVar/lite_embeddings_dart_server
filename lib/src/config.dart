...
class Config {
  ...
  Config({required this.version, required this.server, required this.log, required this.vdb});
...
class VDB {
  ...
  VDB({required this.type, required this.baseUrl});

  factory VDB.fromJson(Map<String, dynamic> json) => _$VDBFromJson(json);
}